...
use simple_types_3::ding;
use simple_types_3::on_off;
use simple_types_3::print_array;
use simple_types_3::print_difference;
use simple_types_3::print_distance;
...
fn main() {
    ...
    //
    let coords_arr = [6.3, 15.0]; // create an array literal out of parts of `coord` here
